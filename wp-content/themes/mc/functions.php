...
function twentysixteen_scripts() {
	...
	// Add Genericons, used in the main stylesheet.
	wp_enqueue_style( 'custom-styles', get_template_directory_uri() . '/css/custom.css', array(), '3.4.1' );
	...
	wp_enqueue_script( 'custom-nav-script', get_template_directory_uri() . '/js/custom.js',  array('jquery'), null, true);
